...
const merchantSchema = new mongoose.Schema({
  ...
  verificationStatus: { type: String, enum: ['pending', 'verifying', 'verified', 'failed'], default: 'pending', index: true },
  verifiedAt: { type: Date, default: null },
  verifiedEmail: { type: String, trim: true, lowercase: true, default: null },
