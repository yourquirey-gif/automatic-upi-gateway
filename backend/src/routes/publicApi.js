...
// Customer-facing payment links are canonical OmniUPI URLs. The payment page on
// omniupi.in talks securely to api.omniupi.in for order/status operations.
...
const statusUrl=${JSON.stringify(`${CANONICAL_API}/api/v1/payment/${encodeURIComponent(order.orderId)}/status`)};
