...
export default function SubscriptionPage() {
  ...
  return <div className="subscription-page">
    ...
    <main className="subscription-main">
      ...
      {verification.verified && <div className="subscription-verification-success"><CheckCircle2 size={18}/><span><b>UPI Verified</b> — {verification.merchant?.upiId} • {verification.merchant?.verifiedEmail}</span></div>}
